        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border-t-4 border-blue-500 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between">
              ...
              {stats.usersGrowth !== 0 && (
                <div className={`flex items-center text-sm font-medium ${stats.usersGrowth > 0 ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className="bg-white rounded-xl shadow-sm border-t-4 border-green-500 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm font-medium mb-1">Lessons</p>
                <h3 className="text-3xl font-bold text-gray-900 mb-2">{stats.totalLessons}</h3>
                <p className="text-sm text-gray-500">Active learning content</p>
              </div>
              {stats.lessonsGrowth !== 0 && (
                <div className={`flex items-center text-sm font-medium ${stats.lessonsGrowth > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  <TrendingUp size={16} className="mr-1" />
          ...
          {/* Quizzes Card */}
          <div className="bg-white rounded-xl shadow-sm border-t-4 border-purple-500 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-gray-600 text-sm font-medium mb-1">Quizzes</p>
                <h3 className="text-3xl font-bold text-gray-900 mb-2">{stats.totalQuizzes}</h3>
                <p className="text-sm text-gray-500">Assessment activities</p>
              </div>
              {stats.quizzesGrowth !== 0 && (
                <div className={`flex items-center text-sm font-medium ${stats.quizzesGrowth > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  <TrendingUp size={16} className="mr-1" />
          ...
          {/* Videos Card */}
          <div className="bg-white rounded-xl shadow-sm border-t-4 border-orange-500 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
              ...
              {stats.videosGrowth !== 0 && (
                <div className={`flex items-center text-sm font-medium ${stats.videosGrowth > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  <TrendingUp size={16} className="mr-1" />
